...
public abstract class Loja {
	...
	public boolean compra(float valor) {
		...
		this.setFundos(this.getFundos() - valor); //Vai colocar o valor no atributo fundos o valor que ele tinha nos fundos menos o valor da compra
		return true;
	}
	
	public void depositar(float valor) {
		
		this.setFundos(this.getFundos() + valor); //Vai colocar o valor no atributo fundos o valor que ele tinha nos fundos mais o valor que ele quer colocar
